 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 26 16:35:27 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                baro_read
...
extern void baro_read_Start_wrapper(real_T *xD);
extern void baro_read_Outputs_wrapper(real_T *P,
  real_T *T,
  const real_T *xD);
extern void baro_read_Update_wrapper(real_T *P,
  real_T *T,
  real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  baro_read_Outputs_wrapper(P, T, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  real_T *T = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *xD = ssGetDiscStates(S);
  baro_read_Update_wrapper(P, T, xD);
}
