###########################################################################
## Makefile generated for component 'barometric_sensors'. 
## 
## Makefile     : barometric_sensors.mk
## Generated on : Thu May 05 11:48:06 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/barometric_sensors.elf
...
PRODUCT_NAME              = barometric_sensors
MAKEFILE                  = barometric_sensors.mk
MATLAB_ROOT               = H:/Programms/MATLAB
MATLAB_BIN                = H:/Programms/MATLAB/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = H:/GF_AERO/LV-1/lv-1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/vzink/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/barometric_sensors.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_EXTMODE_SIMULATION_TIME_IN_TICKS -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DEXTMODE_XCP_TRIGGER_SUPPORT -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2048 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0 -DXCP_MEM_BLOCK_1_SIZE=24 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=32 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=48 -DXCP_MEM_BLOCK_3_NUMBER=1
...
DEFINES_STANDARD = -DMODEL=barometric_sensors -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o barometric_sensors.o barometric_sensors_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o baro_read_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/barometric_sensors_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/barometric_sensors_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/barometric_sensors_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
barometric_sensors.o : $(START_DIR)/barometric_sensors_ert_rtw/barometric_sensors.c
	$(CC) $(CFLAGS) -o "$@" "$<"


barometric_sensors_data.o : $(START_DIR)/barometric_sensors_ert_rtw/barometric_sensors_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/barometric_sensors_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
baro_read_wrapper.o : $(START_DIR)/baro_read_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
