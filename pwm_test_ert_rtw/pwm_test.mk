###########################################################################
## Makefile generated for component 'pwm_test'. 
## 
## Makefile     : pwm_test.mk
## Generated on : Thu May 05 23:04:10 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pwm_test.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pwm_test.elf
...
DEFINES_STANDARD = -DMODEL=pwm_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o xcp_ext_mode.o pwm_test.o pwm_test_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o MW_AVR_InputCaptureDriver.o
...
%.o : $(START_DIR)/pwm_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/pwm_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pwm_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/pwm_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pwm_test.o : $(START_DIR)/pwm_test_ert_rtw/pwm_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pwm_test_data.o : $(START_DIR)/pwm_test_ert_rtw/pwm_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
