###########################################################################
## Makefile generated for component 'arduino_measure_frequency'. 
## 
## Makefile     : arduino_measure_frequency.mk
## Generated on : Thu May 05 19:05:06 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_measure_frequency.elf
...
PRODUCT_NAME              = arduino_measure_frequency
MAKEFILE                  = arduino_measure_frequency.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_measure_frequency.elf
...
DEFINES_STANDARD = -DMODEL=arduino_measure_frequency -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduinoI2C.o MW_Micros.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o arduino_measure_frequency.o arduino_measure_frequency_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_Micros.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/arduinobase/src/MW_Micros.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
arduino_measure_frequency.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/arduino_measure_frequency.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_measure_frequency_data.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/arduino_measure_frequency_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/arduino_measure_frequency_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
