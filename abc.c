 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Apr 22 08:47:17 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                abc
...
extern void abc_Start_wrapper(real_T *xD);
extern void abc_Outputs_wrapper(real_T *P,
  real_T *T,
  const real_T *xD);
extern void abc_Update_wrapper(real_T *P,
  real_T *T,
  real_T *xD);
