...
## 
## Makefile     : imu.mk
## Generated on : Sat Apr 30 20:11:00 2022
...
DEFINES_STANDARD = -DMODEL=imu -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o imu.o imu_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o gy521_read_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
gy521_read_wrapper.o : $(START_DIR)/gy521_read_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
